function [PSeq,fn] = generatePulseSequenceDEER_kang(pi_2, pi, N_pi, pi_2_phases, pi_phaseBlock,corrTime,script,pi_DEER)
    Channels = generateChannels(pi_2, pi, N_pi, pi_2_phases, pi_phaseBlock,corrTime,pi_DEER);
    ...
    if corrTime == 0
        Sweeps = generateSweeps(4,'Type','Duration','Deer',1e-8,1000e-9,51,0,1);
    else
...
function[Channels] = generateChannels(pi_2,pi,N_pi,pi_2_phases, pi_phaseBlock,corrTime,pi_DEER)
...
% Initialize channels1
    ...
    while Channels(4).NumberOfRises < N_pi
        Channels(4).addRise();
    end
    PulseSpacing = 5e-6;
...
%             Channels(4).setRiseParams(i,runningTime,pi/2,'',1.0,pi_2_phases(1),0,1);
        ...
        elseif i == 2
            ...
            Channels(4).setRiseParams(i-1,runningTime + corrTime+pi,pi_DEER,'Deer',1.0,phases(i),0,1);      
            ...
            Channels(4).setRiseParams(i-1,runningTime + corrTime*2+80e-9,pi_DEER,'Deer',1.0,phases(i),0,2);
    ...
    if corrTime~=0
        ...
        for i = 1:Channels(3).NumberOfRises/2
            if i == 1
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises/2,runningTime,pi_2,'corr',1.0,pi_2_phases(2),0,1);
                runningTime = runningTime + pi_2 + PulseSpacing;
            elseif i == Channels(3).NumberOfRises/2
                Channels(3).setRiseParams(i + Channels(3).NumberOfRises/2,runningTime + corrTime,pi_2,'sweep',1.0,pi_2_phases(1),0,1);
    ...
    if corrTime == 0
       ...
       while Channels(4).NumberOfRises < 2*N_pi
            Channels(4).addRise();
        end
...
%                 Channels(4).setRiseParams(i+ Channels(4).NumberOfRises/2,runningTime,0,'',1.0,pi_2_phases(1),0,1);
                runningTime = runningTime + pi_2 + PulseSpacing;
            elseif i == Channels(3).NumberOfRises/2
            ...
            elseif i == 2
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises/2,runningTime + corrTime,pi,'sweep',1.0,phases(i),0,1);
                Channels(4).setRiseParams(i-1+ Channels(4).NumberOfRises/2,runningTime + corrTime+pi,pi_DEER,'Deer',1.0,phases(i),0,1);
                runningTime = runningTime + pi + PulseSpacing + corrTime;
            else
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises/2,runningTime + corrTime*2,pi,'sweep',1.0,phases(i),0,2);
                Channels(4).setRiseParams(i-1+ Channels(4).NumberOfRises/2,runningTime + corrTime*2+80e-9,pi_DEER,'Deer',1.0,phases(i),0,2);
                runningTime = runningTime + pi + PulseSpacing + corrTime*2;
            end
        end
    else % corrTime~=0
        ...
        for i = 1:Channels(3).NumberOfRises/3
            ...
            elseif i == Channels(3).NumberOfRises/3
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises*2/3,runningTime + corrTime,pi_2,'sweep',1.0,pi_2_phases(2),0,1);
                runningTime = runningTime + pi_2 + PulseSpacing + corrTime;
            elseif i == 2
        ...
        for i = 1:Channels(3).NumberOfRises/4
            if i == 1
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises*3/4,runningTime,pi_2,'corr',1.0,pi_2_phases(2),0,1);
                runningTime = runningTime + pi_2 + PulseSpacing;
            elseif i == Channels(3).NumberOfRises/4
                Channels(3).setRiseParams(i+ Channels(3).NumberOfRises*3/4,runningTime + corrTime,pi_2,'sweep',1.0,pi_2_phases(1)+180,0,1);
                runningTime = runningTime + pi_2 + PulseSpacing + corrTime;
            elseif i == 2
...
%         if i == 1 
%             Channels(4).setRiseParams(i,runningTime,pi_2,'',1.0,pi_2_phases(1),0,1);
%             runningTime = runningTime + pi_2 + PulseSpacing;
%         elseif i == Channels(4).NumberOfRises
%             Channels(4).setRiseParams(i,runningTime + corrTime,pi_2,'sweep',1.0,pi_2_phases(2),0,1);
%             runningTime = runningTime + pi_2 + PulseSpacing + corrTime;
%         elseif i == 2
%             Channels(4).setRiseParams(i,runningTime + corrTime,pi,'sweep',1.0,phases(i),0,1);
%             runningTime = runningTime + pi + PulseSpacing + corrTime;
%         else
%             Channels(4).setRiseParams(i,runningTime + corrTime*2,pi,'sweep',1.0,phases(i),0,2);
%             runningTime = runningTime + pi + PulseSpacing + corrTime*2;
%         end
%     end
%     %check if corrTime is non-zero, if it is add additional pulse train
...
%             if i == 1 
%                 Channels(4).setRiseParams(i+ Channels(4).NumberOfRises/2,runningTime,pi_2,'corr',1.0,pi_2_phases(1),0,1);
%                 runningTime = runningTime + pi_2 + PulseSpacing;
%             elseif i == Channels(4).NumberOfRises/1
%                 Channels(4).setRiseParams(i + Channels(4).NumberOfRises/2,runningTime + corrTime,pi_2,'sweep',1.0,pi_2_phases(2),0,1);
%                 runningTime = runningTime + pi_2 + PulseSpacing + corrTime;
%             elseif i == 2
%                 Channels(4).setRiseParams(i + Channels(4).NumberOfRises/2,runningTime + corrTime,pi,'sweep',1.0,phases(i),0,1);
%                 runningTime = runningTime + pi + PulseSpacing + corrTime;
%             else
%                 Channels(4).setRiseParams(i + Channels(4).NumberOfRises/2,runningTime+corrTime*2,pi,'sweep',1.0,phases(i),0,2);
%                 runningTime = runningTime + pi + PulseSpacing + corrTime*2;
%             end
%         end
%     end
...
%     Channels(4).setRiseParams(Channels(4).NumberOfRises,runningTime,0,'End',0,0,0,1);
% %     %Config 2st Ref
%     Channels(1).addRise();
