function [PSeq,fn] = generatePulseSequence_Ramsey_kang(pi_2, pi, N_pi, pi_2_phases, pi_phaseBlock,corrTime,script,ref,RiseAmp)
    ...
    if corrTime == 0
        Sweeps = generateSweeps(3,'Type','Time','sweep',start,stop,101,2,1);
    else
