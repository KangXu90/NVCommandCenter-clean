...
function[Channels] = generateChannels(pi_2,pi,N_pi,pi_2_phases, pi_phaseBlock,corrTime)
    ...
    PulseSpacing = 0; %this value would sweep during experiment
    ...
    runningTime = runningTime + 1e-6 + delay;
    %Configure Counter
    Channels(1).addRise();
    %we can sweep 250e-9 here to get the optimised delay between Laser pulse and DAQ read time
